...
<style>
    ...
    /* FIX: Gradient title (prevents red block) */
    .big-title {
...
def show_stop1_story():
    ...
    st.markdown("""<div class="magic-card"><h3>🎶 A hidden story in the music</h3><p>Some songs in this square are not just music — they are memory, they tell us about the moroccan spirit. Names like <strong>Lalla Aïcha kandicha</strong> echo through the rhythms of <strong>Gnawa</strong>. Aicha Kandicha is more than a legend; in the Moroccan imagination, she becomes a fierce symbol of resistance. Through her mystery, power, and untamed presence, she stands for a people who never fully bowed to domination, carrying in her shadow the spirit of defiance, dignity, and freedom. In this reading, she is not fear alone — she is Morocco’s deep memory of strength, a timeless guardian of identity against every attempt to erase it.</p></div>""", unsafe_allow_html=True)
