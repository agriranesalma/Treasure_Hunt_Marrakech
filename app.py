...
def show_stop1_story():
    ...
    st.text("Aicha Kandicha is more than a legend; in the Moroccan imagination, she becomes a fierce symbol of resistance. Through her mystery, power, and untamed presence, she stands for a people who never fully bowed to domination, carrying in her shadow the spirit of defiance, dignity, and freedom. In this reading, she is not fear alone — she is Morocco’s deep memory of strength, a timeless guardian of identity against every attempt to erase it.")
