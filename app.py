...
stops_data = {
    1: {
        ...
        "national_memory": "But this square is not only a place of stories and music — it is also a place of memory. Jemaa el-Fnaa wasn't just a marketplace; it was a heartbeat. In the 1950s, while the world watched the performers, a secret spirit of resistance was brewing right here. This energy eventually flowed south, echoing the legendary moment when King Mohammed V stood in the sands of M’Hamid El Ghizlane to reclaim the desert’s soul. It was a handshake between the city and the Sahara that changed everything.",
